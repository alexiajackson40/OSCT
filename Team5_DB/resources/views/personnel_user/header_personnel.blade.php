...
<body>
    <div class="container-fluid main-body">
        <div class="header-container d-flex flex-row"> 
            ...
            <div class="user-container">
                <a class="btn btn-light" href="{{ route('personnel.profile') }}" role="button">
                    <img src="{{ asset('img/The_Donkey.JPEG') }}" class="img-thumbnail" alt="logo" width="50" height="50">
                    Profile 
                </a>
            </div>
        </div>
    ...
    <div class="navigation-container">
        <nav class="nav nav-pills nav-fill">
            <a class="nav-link" href="{{ route('personnel.home') }}">Home:Personnel</a>
            <a class="nav-link" href="{{ route('personnel.users') }}">Users</a>
            <a class="nav-link" href="{{ route('personnel.schedule') }}">Schedule</a>
        </nav>
    </div>
    ...
    <style>
        ...
        .btn {
            ...
            align-items: center;
            border: 2px solid var(--light-surface-three);
            border-radius: 10px;
            cursor: pointer; 
            font-size: 16px;
            font-weight: 500;
        ...
        .nav-pills .nav-link {
            ...
            --bs-nav-link-font-size: 20px !important; 
            font-weight: 600;
        }
        .nav-pills .nav-link.active {
            background-color: var(--light-surface-three) !important;
            border-bottom: 4px solid #7C1332 !important;
            font-weight: 600;
            width: 125px !important;
