<!DOCTYPE html>
<html lang="en">
<!-- Personnel User Patient Measurements Page -->
<body>
                    ...
                    <div class="measurements-container d-flex flex-column align-items-left">
                        <table class="info-table">
                            ...
                            <tr>
                                ...
                                <td>{{ $measurements->hip }} cm</td>
                            </tr>
                            <tr>
                                <td><strong>Waist to Hip Ratio:</strong></td>
                                <td>{{ $measurements->waist_to_hip_ratio }}</td>
                            </tr>
                            <tr>
                                <td><strong>Body Mass:</strong></td>
                                <td>{{ $measurements->body_mass }}</td>
                            </tr>
                            <tr>
                                <td><strong>Cholesterol:</strong></td>
                                <td>{{ $measurements->cholesterol }} mg/dL</td>
                            </tr>
                            <tr>
                                <td><strong>Glucose Level:</strong></td>
                                <td>{{ $measurements->glucose_level }} mg/dL</td>
                            </tr>
                            <tr>
                                <td><strong>Hemoglobin:</strong></td>
                                <td>{{ $measurements->hemoglobin }} %</td>
                            </tr>
                            <tr>
                                <td><strong>Triglycerides:</strong></td>
                                <td>{{ $measurements->triglycerides }} mg/dL</td>
                            </tr>
                        </table>
                    </div>
                </div>
